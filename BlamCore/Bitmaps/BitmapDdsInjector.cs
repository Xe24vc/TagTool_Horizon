...
namespace BlamCore.Bitmaps
{
    public class BitmapDdsInjector
    {
        ...
        public void InjectDds(TagSerializer serializer, TagDeserializer deserializer, Bitmap bitmap, int imageIndex, Stream ddsStream)
        {
            ...
            var newResource = true; // always add as new resource for max speed. It's very slow replacing old resources.
            ...
            if (newResource)
                CacheContext.AddResource(resource, ResourceLocation.Textures, ddsStream);
            else
