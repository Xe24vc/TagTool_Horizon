...
using ShapeTypes = BlamCore.TagDefinitions.PhysicsModel.RigidBody.ShapeTypeValue;
using MotionTypeValue = BlamCore.TagDefinitions.PhysicsModel.RigidBody.MotionTypeValue;
