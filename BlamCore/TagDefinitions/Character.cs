...
namespace BlamCore.TagDefinitions
{
    ...
    public class Character
    {
        ...
        public List<InspectProperty> InspectProperties;
        ...
        public class WeaponsProperty
        {
            ...
            public WeaponSpecialFireMode SpecialFireMode;
            public WeaponSpecialFireSituation SpecialFireSituation;
            ...
            public enum WeaponSpecialFireMode : short
            {
                None,
                Overcharge,
                SecondaryTrigger,
            ...
            public enum WeaponSpecialFireSituation : short
            {
                Never,
                EnemyVisible,
                EnemyOutOfSight,
