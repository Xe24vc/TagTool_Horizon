...
{
    [TagStructure(Name = "sound", Class = "snd!", Size = 0xD4, MaxVersion = CacheVersion.HaloOnline235640)]
    [TagStructure(Name = "sound", Class = "snd!", Size = 0xD8, MinVersion = CacheVersion.HaloOnline301003, MaxVersion = CacheVersion.HaloOnline449175)]
    [TagStructure(Name = "sound", Class = "snd!", Size = 0xD4, MinVersion = CacheVersion.HaloOnline498295)]
    public class Sound
    {
        public uint Flags;
        public uint Unknown;
