...
namespace BlamCore.Common
{
    ...
    public struct RealVector4d
    {
        ...
        /// <param name="w">The W component.</param>
        public RealVector4d(RealVector2d xy, float z, float w)
        {
            I = xy.I;
            J = xy.J;
            K = z;
        ...
        /// <param name="w">The W component.</param>
        public RealVector4d(RealVector3d xyz, float w)
        {
            I = xyz.I;
            J = xyz.J;
            K = xyz.K;
        ...
        /// </summary>
        public RealVector2d XY { get { return new RealVector2d(I, J); } }

        /// <summary>
        /// Gets the X, Y, and Z components of the vector as a 3D vector.
        /// </summary>
        public RealVector3d XYZ { get { return new RealVector3d(I, J, K); } }
