...
{
    class PortFullModelCommand : Command
    {
        public GameCacheContext CacheContext { get; }
        public CacheFile BlamCache { get; }

        public PortFullModelCommand(GameCacheContext cacheContext, CacheFile blamCache)
            : base(CommandFlags.None,

                  "PortModel",
                  "Ports a blam model tag to the current cache.",

                  "PortModel [New] <Blam Tag> <ElDorado Tag>",
